...
(1.96)^{2}*(scaledCovarianceMatrix("sev", (log(50)-4.81)/0.50)["v22"])/(log(2.0)^2)
...
(1.96)^2*(scaledCovarianceMatrix("normal", (log(120)-6.21)/1.4)["v22"])/(log(2.0)^2)
...
(1.96)^2*(0.50)^2*(varianceFactorQuantile(0.10, psev((log(50)-4.81)/0.50), "sev"))/(log(1.5)^2)
...
(1.96)^2*(1.4)^2*(varianceFactorQuantile(0.10, pnorm((log(120)-6.21)/1.4), "normal"))/(log(2.0)^2)
